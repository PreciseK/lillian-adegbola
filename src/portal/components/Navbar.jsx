...
const Navbar = ({ isLoggedIn, user, onLogout }) => {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/portal/dashboard', icon: FiHome },
    { name: 'Resources', href: '/portal/resources', icon: FiGift },
    { name: 'Courses', href: '/portal/courses', icon: FiBook },
    { name: 'Shop', href: '/portal/shop', icon: FiShoppingBag },
  ];
